...
export const patientNotifications = [
  {
    ...
    message:
      "Your resting heart rate reached 96 bpm this afternoon. Take a short breathing break and recheck in 15 minutes.",
    time: "5 min ago",
    icon: "activity",
    color: "#ef4444",
    bg: "#fee2e2",
  ...
  },
  {
    ...
    message:
      "Last night you logged 7h 32m of sleep. Your sleep consistency is improving this week.",
    time: "42 min ago",
    icon: "moon",
    color: "#8b5cf6",
    bg: "#f3e8ff",
  ...
  },
  {
    ...
    message:
      "You completed 6k of your 10k step goal. A 20 minute walk will keep you on pace today.",
    time: "1 hour ago",
    icon: "dumbbell",
    color: "#10b981",
    bg: "#d1fae5",
  ...
  },
  {
    ...
    message:
      "You have not recorded your mood today yet. A quick check-in helps your doctor follow your progress.",
    time: "Today",
    icon: "heart",
    color: "#ec4899",
    bg: "#fce7f3",
        ...
        items: [
          {
            ...
            subtitle: "Inhale for 4 seconds, hold for 7, exhale for 8",
            meta: "4 minutes",
            icon: "timer",
          },
          {
            title: "Box Breathing",
            subtitle: "Equal time for inhale, hold, exhale, hold",
            meta: "5 minutes",
            icon: "square",
          },
          {
        ...
        items: [
          {
            ...
            preview:
              "Started the day with meditation and felt more centered...",
            mood: "\u{1F60A}",
          },
          {
            date: "Yesterday",
            title: "Reflections on work",
            preview: "The meeting went well but I felt a bit anxious about...",
            mood: "\u{1F610}",
          },
          {
            date: "2 days ago",
            ...
            preview:
              "Counting my blessings today - good health, loving family...",
            mood: "\u{1F604}",
          },
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Relax with a good book before bed",
            progress: 0.5,
            status: "In Progress",
            time: "8:30 PM",
            color: "#f59e0b",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            title: "Completed Breathing Exercise",
            subtitle: "4-7-8 Breathing - 4 minutes",
            time: "2 hours ago",
            icon: "wind",
            color: "#6366f1",
          },
          {
            ...
            subtitle: "Daily reflection - Mood: \u{1F60A}",
            time: "5 hours ago",
            icon: "book-open",
            color: "#8b5cf6",
          },
          {
            ...
            subtitle: "Evening walk - 30 minutes",
            time: "Yesterday",
            icon: "dumbbell",
            color: "#10b981",
          },
          {
            ...
            subtitle: "7h 32m sleep - Quality: Good",
            time: "Yesterday",
            icon: "moon",
            color: "#ec4899",
          },
          {
            title: "Goal Achieved",
            subtitle: "Morning meditation completed",
            time: "2 days ago",
            icon: "check-circle",
            color: "#6366f1",
          },
          {
            ...
            subtitle: "Feeling positive and energized",
            time: "2 days ago",
            icon: "smile",
            color: "#f59e0b",
          },
          {
            ...
            subtitle: "Read for 20 minutes daily",
            time: "3 days ago",
            icon: "flag",
            color: "#3b82f6",
          },
          {
            ...
            subtitle: "Box breathing - 5 minutes",
            time: "3 days ago",
            icon: "wind",
            color: "#6366f1",
          },
          {
            title: "Journal Entry Added",
            subtitle: "Weekly reflection and planning",
            time: "4 days ago",
            icon: "book-open",
            color: "#8b5cf6",
          },
          {
            ...
            subtitle: "Yoga practice - 25 minutes",
            time: "4 days ago",
            icon: "sparkles",
            color: "#10b981",
          },
