...
export default function SignInPage() {
  ...
  return (
    <main className="auth-shell grid min-h-screen place-items-center px-4 py-6 sm:px-6 lg:px-10">
      <section className="grid w-full max-w-6xl gap-5">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(360px,480px)]">
          ...
          <div className="grid gap-5">
            <Card className="auth-card rounded-xl border-slate-200/95 p-6 text-left shadow-[0_18px_36px_rgba(15,23,42,0.08)] sm:p-7">
            ...
            <Card className="auth-demo-card rounded-xl border-[#d8e8f8] bg-[#eef6ff] p-5 shadow-[0_18px_36px_rgba(59,130,246,0.08)]">
              <div className="mb-4 flex items-start gap-3">
                <span className="auth-field-icon grid h-10 w-10 place-items-center rounded-xl bg-white shadow-sm shadow-blue-950/5">
              ...
              <div className="grid gap-3">
                {demoAccounts.map((account) => (
                  <button
                    type="button"
                    className="auth-demo-row grid w-full grid-cols-[auto_1fr_auto] items-center gap-3 rounded-xl border border-blue-100 bg-white p-3 text-left transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-65"
                    key={account.email}
                    onClick={() => selectDemoAccount(account)}
                    disabled={authLoading}
                  >
                    <span className="auth-field-icon grid h-10 w-10 place-items-center rounded-xl bg-blue-50">
