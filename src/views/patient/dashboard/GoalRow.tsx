    ...
    <div className="patient-list-row rounded-lg border border-slate-100 bg-slate-50/70 p-3 transition hover:border-violet-100 hover:bg-white">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <span className="mt-1 block text-xs font-semibold text-slate-500">{goal.current} / {goal.target}</span>
        </div>
        <span className="rounded-lg bg-white px-2 py-1 text-xs font-bold text-slate-600 shadow-sm shadow-slate-950/5">{percentage}%</span>
      </div>
      <div className="mt-3">
