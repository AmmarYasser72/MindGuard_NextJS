...
export default function MetricTile({ metric }) {
  return (
    <div className="grid min-h-28 content-between rounded-lg border border-white/80 p-4 shadow-sm shadow-slate-950/5 transition hover:-translate-y-0.5 hover:shadow-md" style={{ backgroundColor: metric.bg }}>
      ...
      <div>
        <strong className="block text-2xl font-bold" style={{ color: metric.color }}>{metric.value}</strong>
