  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="rounded-lg bg-white/80 px-2 py-1 text-[11px] font-bold text-slate-500">
          Today
        </span>
      </div>
      <div>
        <strong className="block text-2xl font-bold text-[var(--metric-color)]">
          {metric.value}
        </strong>
        <small className="mt-1 block text-xs font-bold text-slate-600">
          {metric.label}
        </small>
      </div>
    </div>
