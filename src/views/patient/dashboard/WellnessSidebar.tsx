...
import { dailyGoals, recentActivities, wellnessMetrics } from "../../../data/patientData";
...
export default function WellnessSidebar({ completedGoals, onNavigate }: WellnessSidebarProps) {
  return (
    <aside className="space-y-6">
      ...
      <DashboardPanel>
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <button type="button" className="rounded-lg px-2 py-1 text-sm font-bold text-[var(--primary)] hover:bg-violet-50" onClick={() => onNavigate("/daily-goals")}>View all</button>
        </div>
      ...
      <DashboardPanel>
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <button type="button" className="rounded-lg px-2 py-1 text-sm font-bold text-[var(--primary)] hover:bg-violet-50" onClick={() => onNavigate("/recent-activity")}>See all</button>
        </div>
        <div className="space-y-3">
