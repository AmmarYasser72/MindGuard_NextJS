...
function ChatComposer({ draft, isDisabled, onDraftChange, onSend }: ChatComposerProps) {
  ...
  return (
    ...
    >
      <textarea
        className="min-h-12 max-h-28 min-w-0 flex-1 resize-none rounded-[1rem] bg-[#f3edfb] px-5 py-3.5 text-sm font-semibold leading-5 text-slate-900 outline-none placeholder:text-[#b5adc2] focus:ring-4 focus:ring-[#eadfff] disabled:cursor-not-allowed disabled:opacity-70 md:min-h-14 md:text-[0.95rem] xl:min-h-16"
        value={draft}
