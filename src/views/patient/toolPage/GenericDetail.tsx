...
export default function GenericDetail({
  ...
  const progressPercent =
    item.progress !== undefined ? Math.round(item.progress * 100) : null;
        ...
        <section className={panelClass}>
          <div className="flex items-start gap-3">
            ...
            <span className="min-w-0">
              ...
              <small className="mt-1 block text-sm font-semibold leading-6 text-slate-500">
                {item.subtitle || item.description || item.meta || item.time}
              </small>
            </span>
          </div>
