    ...
    <Card className="grid gap-4 rounded-[1.5rem] p-5 sm:p-6">
      ...
      <div className="grid gap-3">
        {techniques.map((technique) => (
          <div
            className="patient-analytics-row grid gap-3 rounded-[1.25rem] border border-slate-200 bg-slate-50/80 p-4 lg:grid-cols-[auto_1fr_auto] lg:items-center"
            key={technique.name}
          >
            <span
            ...
            <button
              ...
              onClick={() =>
                showToast(`${technique.name} ready to start`, "success")
              }
            >
