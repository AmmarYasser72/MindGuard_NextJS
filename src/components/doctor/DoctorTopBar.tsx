    ...
    <header className="dashboard-glass sticky top-0 z-20 border-b px-4 py-3 sm:px-6 lg:px-8">
      <div className="flex w-full items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="dashboard-outline-btn hidden rounded-lg px-3 py-2 text-sm font-bold sm:inline-flex"
          ...
          <button
            type="button"
            className="dashboard-outline-btn grid h-10 w-10 place-items-center rounded-lg"
            aria-label="Logout"
            title="Logout"
            onClick={onLogout}
          >
